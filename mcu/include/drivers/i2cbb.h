...
#define I2CBB_BUSY_PORT     LED_TEST1_PORT
#define I2CBB_BUSY_PIN      LED_TEST1_PIN

#define I2CBB_DELAY         __asm__ __volatile__("nop"); \
...
void i2cbb_init(void); // initialize i2c
